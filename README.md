...
| `skip_brightness_increases`    | Skip sending adaptation commands when the light entity is already dimmed below the the current target brightness. Lights will only ever get dimmer with this command enabled.                                                                                                                                                                      | `False`        | `bool`                                 |
